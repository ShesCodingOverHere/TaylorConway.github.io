...
Analysis of nuclear mitochondrial DNA (NUMT) distribution across chromosomes.
...
- Designed BLAST-based workflows with adjustable sensitivity  
- Implemented best-hit filtering strategies  
- Processed and summarized alignment outputs  
